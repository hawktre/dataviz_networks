...
![](figures/wheat_striperust_wide.jpg){height="350px"}
:::
...
::: {style="text-align: center;"}
![](figures/experimental_design_2024_blockC.png){height="400px"}
:::
...
## Discussion{style="font-size: 0.5em;"}

Here are my current visualizations from the project:

::: {style="text-align: center;"}
![](figures/spatplot_2024_A4.png){height="400px"}
:::
